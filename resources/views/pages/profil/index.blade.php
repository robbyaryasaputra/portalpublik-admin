            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Identitas Desa</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Lokasi Administratif</th>
                ...
                <tr>
                      ...
                      <div>
                        ...
                        @else
                            ...
                            @php
                                ...
                                $randomColor = $colors[$item->profil_id % count($colors)];
                            @endphp
                            <div class="avatar avatar-sm me-3 border-radius-lg {{ $randomColor }} d-flex align-items-center justify-content-center text-white fw-bold shadow-sm">
                                {{ $initials }}
                            </div>
                        @endif
                      </div>
                  ...
                  <td class="text-center align-middle">
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        {{-- Tombol Hapus (Merah) --}}
                        <form action="{{ route('profil.destroy', $item->profil_id) }}" method="POST" style="display:inline" onsubmit="return confirm('Yakin ingin menghapus data profil desa ini?')">
                            @csrf
                            @method('DELETE')
                ...
                <tr>
                  <td colspan="5" class="text-center py-4">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <i class="material-icons opacity-4 text-secondary text-4xl">domain_disabled</i>
                        <span class="text-secondary text-sm mt-2">Data profil belum tersedia.</span>
                    </div>
                  </td>
                </tr>
                @endforelse
