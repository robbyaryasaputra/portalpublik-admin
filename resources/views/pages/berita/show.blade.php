        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow-sm mb-4">
                <div class="card-body p-3">
                    @if($berita->cover)
                        <img src="{{ asset('storage/' . $berita->cover) }}" class="img-fluid border-radius-lg shadow-sm w-100 mb-3" alt="cover">
                    @else
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item border-0 ps-0 text-sm">
                            <strong class="text-dark">Kategori:</strong> &nbsp; {{ $berita->kategoriBerita->nama ?? '-' }}
                        </li>
                        <li class="list-group-item border-0 ps-0 text-sm">
                        ...
                        @foreach($berita->gallery as $gal)
                            <div class="col-6 col-md-3">
                                <a href="{{ asset('storage/' . $gal->file_url) }}" target="_blank">
                                    <img src="{{ asset('storage/' . $gal->file_url) }}" class="img-fluid border-radius-lg shadow-sm w-100" style="height: 120px; object-fit: cover;">
                                </a>
                            </div>
                        @endforeach
                    </div>
